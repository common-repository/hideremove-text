function promo_hunt_copy_shortcode() {
  // Create a dummy input to copy the string array inside it
  var dummy = document.createElement("input");
  var button = document.getElementById("promo_hunt_copy_shortcode_button");

  // Add it to the document
  document.body.appendChild(dummy);

  // Set its ID
  dummy.setAttribute("value", "[promo_hunt]");
...
function loadScript() {
  // Get the modal
  var modal = document.getElementById("promo_hunt_modal");

  // Get the button that opens the modal
  var btn = document.getElementById("promo_hunt_image");
  if (!btn) return;

  // Get the <span> element that closes the modal
  var span = document.getElementsByClassName("promo_hunt_close")[0];
